...
int	is_builtin(char *line)
{
	...
	if (!ft_strcmp(split_line[0], "cd") || \
		!ft_strcmp(split_line[0], "echo") || \
		!ft_strcmp(split_line[0], "env") || \
		!ft_strcmp(split_line[0], "export") || \
		!ft_strcmp(split_line[0], "pwd") || \
		!ft_strcmp(split_line[0], "unset"))
	{
